...
const EditRecipe = () => {
  ...
  const [ration, setRation] = useState<Ration>({
    value: 1,
    unit: rationUnitOptions[0],
  });
    ...
    <>
      <div className=" w-full lg:px-[100px] mx-auto p-4 xl:flex gap-9 pt-[30px] lg:pt-[60px]">
        ...
        <div className="font-[300] w-full xl:w-3/5 font-Inter">
          <h1 className=" text-2xl text-center font-lobster font-[600] mb-4 lg:text-[45px] lg:mb-[50px]">
            Edit Recipe
          </h1>
            ...
            <div className="mb-4">
              ...
              <div className="flex items-center border-[1px] border-[#cbcbcb] rounded overflow-hidden">
                <input
                  ...
                  value={ration.value}
                  onChange={(e) =>
                    handleRationValueChange(Number(e.target.value))
                  }
                  required
                  min="1"
