...
// // Cấu trúc menuItems với các mục chính và href cho từng menu
// const createMenuItems = (isAdmin: boolean) => ({
//   Home: { label: "Home", href: "/", subItems: [] },
//   Recipes: { label: "Recipes", href: "/recipes", subItems: [] },
//   Categories: { label: "Categories", href: "/categories", subItems: [] },
//   Blog: { label: "Blog", href: "/blog", subItems: [] },
...
//     label: "Contact", 
//     href: "#", 
//     subItems: [{ label: "Add recipe", href: "/add_recipe" }, { label: "Generate", href: "/generate" }] 
//   },
//   Library: { 
//     label: "Library", 
//     href: "#", 
...
//   const [stateSideMenu, setSatteSideMenu] = useState<boolean>(false);
//   const [isLoggedIn, setIsLoggedIn] = useState<boolean>(false); // Thêm state để kiểm tra trạng thái đăng nhập
//   const [isAdmin, setIsAdmin] = useState<boolean>(false); // Thêm state để kiểm tra trạng thái admin
...
//   useEffect(() => {
//     const token = localStorage.getItem("accessToken");
//     setIsLoggedIn(token !== null && infoUser !== null);
//     setIsAdmin(infoUser?.role === "admin"); // Kiểm tra vai trò
//   }, [infoUser]);

//   const menuItems = createMenuItems(isAdmin); // Tạo menuItems dựa trên trạng thái admin
