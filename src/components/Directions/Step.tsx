...
//             <div className="bg-green-200 w-full h-fit flex justify-center">
//               <div className="bg-red-200 w-[294px] xl:w-[313px] flex gap-1 flex-wrap">
//                 {[
...
//                   <Image
//                     key={index}
//                     className="w-[70px] h-[70px] xl:w-[100px] xl:h-[100px] rounded-[5px] object-cover object-center transition-transform duration-500 ease-in-out transform group-hover:scale-105 cursor-pointer"
//                     src={src}
//                     alt="Pancake"
//                     width={100}
//                     height={100}
...
const Step: FC<StepProps> = ({ title, description, images }) => {
  const [selectedImage, setSelectedImage] = useState<string | null>(null);
    ...
    <>
      <li className=" flex flex-col">
        ...
        <div className=" my-4 w-full h-fit flex justify-center">
          <div className=" w-[294px] xl:w-[313px] flex gap-1 flex-wrap">
