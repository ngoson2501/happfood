    ...
    <>
      <div className="w-full h-[550px] flex mt-[175px]">
        <div className="w-[100%] font-Inter h-full flex flex-col justify-center gap-[40px]">
          <p className="w-[90%] font-[600] text-[50px]" style={{ lineHeight: "1.2" }}>
          ...
          <p style={{ color: "rgba(0, 0, 0, 60%)" }} className="font-[300] w-[80%]">
            ...
            you are following a recipe or experimenting with flavors, the kitchen
            is your canvas, and you are the artist.
          </p>
          <span className="bg-black w-fit rounded-[17px] text-white px-[50px] py-[20px] mt-[70px]">
            Learn More
          </span>
        </div>
