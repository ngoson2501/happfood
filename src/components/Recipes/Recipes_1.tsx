...
<>
      <section className="bg-[#E7FAFE]  lg:bg-gradient-to-b lg:from-white lg:to-[#E7FAFE]  group w-[180px] lg:w-[380px] lg:h-[400px] h-[240px] px-[10px] py-[10px] lg:px-[20px] lg:py-[20px] rounded-[10px] sm:rounded-[20px] cursor-pointer flex flex-col justify-between hover:shadow-lg">
        ...
        <div className="flex gap-[10px]">
          <div className="px-[10px] gap-1 py-[5px] lg:px-[15px] lg:gap-2 lg:py-[7px] flex justify-center items-center rounded-full">
            <Image src="/icon/Timer.svg" alt="Timer" width={16} height={16} />
            <p className="text-[12px] lg:text-[15px]">30p</p>
          </div>
          <div className="px-[10px] gap-1 py-[5px] lg:px-[15px] lg:gap-2 lg:py-[7px] flex justify-center items-center rounded-full">
            <Image src="/icon/ForkKnife.svg" alt="ForkKnife" width={16} height={16} />
            <p className="text-[12px] lg:text-[15px]">sweet</p>
          </div>
        </div>
      </section>
    </>
