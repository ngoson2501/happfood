...
<>
      <section className="bg-gradient-to-b from-white to-[#E7FAFE]  group w-[180px] h-[240px] px-[10px] pb-[10px] rounded-[10px] sm:rounded-[20px] cursor-pointer flex flex-col justify-between hover:shadow-lg">
        <div className="w-full h-[130px] relative overflow-hidden rounded-[8px] sm:rounded-[15px]">
          <Image
            className="w-full h-full object-cover object-center absolute inset-0 transition-transform duration-500 ease-in-out transform group-hover:scale-110"
            src="/images/food-img/Pancake.svg"
            alt="Pancake"
            ...
            height={130}
          />
          <div className="absolute z-10 w-[30px] h-[30px] right-0 flex justify-center items-center">
            <div className="bg-white w-[20px] h-[20px] rounded-full flex gap-1 justify-center items-center">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                fill="currentColor"
        ...
        <p
          className=" font-Inter font-[600] text-[16px] line-clamp-2 truncate whitespace-normal text-clip overflow-hidden"
          style={{ lineHeight: "1.4" }}
        >
          Fruity Pancake with Orange & Blueberry
        </p>
        <div className="flex gap-[10px]">
          <div className="px-[10px] gap-1 py-[5px] flex justify-center items-center rounded-full">
            <Image src="/icon/Timer.svg" alt="Timer" width={16} height={16} />
            <p className="text-[12px]">30p</p>
          </div>
          <div className="px-[10px] gap-1 py-[5px] flex justify-center items-center rounded-full">
            <Image src="/icon/ForkKnife.svg" alt="ForkKnife" width={16} height={16} />
            <p className="text-[12px]">sweet</p>
          </div>
        </div>
      </section>
    </>
