...
//   return (
//     <>
//       <section className="bg-gradient-to-b from-white to-[#E7FAFE] w-[400px]  h-[400px] px-[20px] pb-[20px] rounded-[30px] flex flex-col justify-between hover:shadow-lg ">
//         <div className="bg-red-400 w-full h-[230px] relative overflow-hidden rounded-[20px]">
//           <img
